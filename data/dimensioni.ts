...
export const dimensioni: Record<string, [number, number]> = {
  ...
  "/progetti/postura-da-paura/banner-desk.webp": [2000, 1050],
  "/progetti/postura-da-paura/banner-lilla.webp": [2000, 1181],
